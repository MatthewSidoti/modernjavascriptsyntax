...
// Your code here
const multiplied = nums.map((currentElement) => {
...
const firstPizza= [pizzaToppings[0], pizzaToppings[1]];
...
let pizza4 = 'not tasty';

pizza4 === 'tasty' ? console.log('yum') : console.log('yuck');
